...
class _RemotePadState extends State<RemotePad> {
  ...
  void _handlePower() {
    FirebaseService.sendCommand(command: 'power');
  ...
  void _handleMenu() {
    FirebaseService.sendCommand(command: 'menu');
    ScaffoldMessenger.of(
      context,
  ...
  void _handleVolumeUp() {
    ...
    FirebaseService.sendCommand(command: 'volume_up', value: _volume.toInt());
    ScaffoldMessenger.of(
      context,
  ...
  void _handleVolumeDown() {
    ...
    FirebaseService.sendCommand(command: 'volume_down', value: _volume.toInt());
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('음량: ${_volume.toInt()}%')));
  }
  ...
  void _handleChannelUp() {
    ...
    FirebaseService.sendCommand(command: 'channel_up', value: _channel);
    ScaffoldMessenger.of(
      context,
  ...
  void _handleChannelDown() {
    ...
    FirebaseService.sendCommand(command: 'channel_down', value: _channel);
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('채널: $_channel')));
  }
  ...
  void _handleHome() {
    FirebaseService.sendCommand(command: 'mute');
    ScaffoldMessenger.of(
      context,
  ...
  void _handleSettings() async {
    ...
    FirebaseService.sendCommand(command: 'home');
  ...
  void _handleTV() {
    FirebaseService.sendCommand(command: 'back');
    ScaffoldMessenger.of(
      context,
  ...
  void _handleCircle() {
    FirebaseService.sendCommand(command: 'circle');
    ScaffoldMessenger.of(
      context,
  ...
  void _handleOK() {
    FirebaseService.sendCommand(command: 'click');
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('확인 버튼을 눌렀습니다')));
  }

  // 방향키 핸들러 추가 (UI에 연결 필요)
  // ignore: unused_element
  void _handleUp() {
    FirebaseService.sendCommand(command: 'up');
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('위로 이동')));
  }

  // ignore: unused_element
  void _handleDown() {
    FirebaseService.sendCommand(command: 'down');
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('아래로 이동')));
  }

  // ignore: unused_element
  void _handleLeft() {
    FirebaseService.sendCommand(command: 'left');
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('왼쪽으로 이동')));
  }

  // ignore: unused_element
  void _handleRight() {
    FirebaseService.sendCommand(command: 'right');
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('오른쪽으로 이동')));
  }
